  ...
  const getAgentInfo = (agent: string) => {
    switch (agent) {
      ...
      case 'predictor':
        return { 
          name: 'The Predictor', 
          png: '/WIZZARD/The Predictor.webm',
          bgColor: 'bg-white/5',
          borderColor: 'border-white/20'
        };
      case 'quantum-eraser':
        return { 
          ...
          png: '/WIZZARD/The Quantum Eraser.webm',
          bgColor: 'bg-white/5',
          borderColor: 'border-white/20'
        };
      case 'retrocausal':
        return { 
          ...
          png: '/WIZZARD/The Retrocasual.webm',
          bgColor: 'bg-white/5',
          borderColor: 'border-white/20'
        };
      case 'system':
            ...
            return (
              <div key={message.id} className="flex items-end space-x-3">
                ...
                <div className="flex flex-col max-w-[80%]">
                  ...
                  <div className="bg-white/10 border border-amber-400/30 rounded-2xl rounded-bl-md px-4 py-3 shadow-lg">
