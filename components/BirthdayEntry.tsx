        ...
        {!showZodiac ? (
          <div className="flex space-x-4 justify-center">
            <input
              ...
              className={`w-20 px-4 py-3 bg-black/20 border-2 border-[#FFD700]/60 rounded-lg text-white text-lg focus:outline-none focus:border-[#FFD700]/80 transition-all duration-500 text-center ${
          ...
          <div className="space-y-4">
              ...
              <div className={`w-96 h-96 mx-auto transition-all duration-500 ease-out ${
                ...
                <div className="relative w-full h-full">
                  ...
                  <div className={`absolute inset-0 bg-black/30 backdrop-blur-sm rounded-lg flex flex-col items-center justify-center transition-opacity duration-300 ${
                    ...
                    <div className="animate-spin rounded-full h-16 w-16 border-4 border-[#FFD700]/30 border-t-[#FFD700] mb-4"></div>
            ...
            <div className="space-y-3 -mt-2">
              ...
              className={`px-8 py-4 bg-transparent border-2 border-[#FFD700]/60 rounded-lg text-white text-lg hover:border-[#FFD700]/80 hover:bg-[#FFD700]/10 transition-all duration-300 focus:outline-none focus:border-[#FFD700]/80 ${
                showZodiacVideo ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'
              }`}
              style={{ fontFamily: 'VT323, monospace' }}
              >
