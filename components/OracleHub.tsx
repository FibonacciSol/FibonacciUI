...
export default function OracleHub({ isOpen, onClose }: OracleHubProps) {
  ...
  return (
    <>
      ...
      <div 
        className={`oracle-hub fixed right-0 top-0 h-full w-1/2 bg-black border-l border-amber-400/40 z-[60] transition-all duration-700 ease-in-out flex flex-col overflow-hidden ${
      ...
      >
        ...
        {/* Header */}
  <div className="p-8 border-b border-amber-400/40">
          ...
          <div className="space-y-4 h-full flex flex-col">
            ...
            <div className="flex-shrink-0">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-white/5 border border-amber-400/30 rounded p-2">
            ...
            <div className="flex-shrink-0">
              ...
              <div className="bg-white/5 border border-amber-400/30 rounded p-3">
                ...
                {!connectionStatus.isConnected && (
                  <button
                    ...
                    className="mt-2 px-3 py-1 bg-white/10 border border-amber-400/30 rounded text-white/80 hover:text-white hover:bg-white/20 transition-colors duration-200 text-sm"
                    style={{ fontFamily: 'VT323, monospace' }}
                  >
                    Reconnect
                  </button>
            ...
            <div className="flex-1 flex flex-col min-h-0">
              ...
              {isArchiveMode && (
                <div className="mb-3">
                  <input
                    ...
                    className="w-full px-3 py-2 bg-black/50 border border-amber-400/30 rounded text-white placeholder-white/40 focus:outline-none focus:border-amber-400/30"
                    style={{ fontFamily: 'VT323, monospace' }}
                  />
                </div>
              )}
              ...
              {isArchiveMode ? (
        <div className="bg-black/50 border border-amber-400/30 rounded p-2 overflow-y-auto flex-1">
                    <div className="space-y-2">
                      {getFilteredArchives().map((archive) => (
                        <div 
                          key={archive.id} 
                          className="p-3 bg-black/30 border border-amber-400/20 rounded cursor-pointer hover:bg-black/50 transition-colors"
                          onClick={() => {
                ...
                <div className="bg-black/50 border border-amber-400/30 rounded p-2 overflow-hidden flex-1">
