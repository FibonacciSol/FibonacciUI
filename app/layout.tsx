...
export const metadata = {
  title: 'Fibonacci — Retrocausal Market Engine',
  description: 'Fibonacci is a Solana-native prediction framework fusing quantum logic, retrocausality, and simulation theory to forecast market movements beyond probability.',
}
