  ...
  return (
    <ErrorBoundary>
      <main className="fixed inset-0 overflow-visible">
        ...
        />
  <BottomNavigation isNavigationHubOpen={isNavigationHubOpen} isOracleHubOpen={isOracleHubOpen} isScopeOpen={isScopeOpen} hideSocials={true} />
        ...
        {/* Fibonacci animation in the background */}
